...
<!-- Form -->
<el-button size="mini" type="primary" @click="dialogFormAdd = true">add bands
 ...
 export default {
    ...
    methods:{
      addBrand(){
        ...
        return this.$store.dispatch('brand/add',this.form)
        .then((res) =>{
       ...
       submitFile(){
         ...
         */
             axios.post( 'https:api.meiboutiques.work/v1/admin/brands',
